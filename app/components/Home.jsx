...
export default function OverClan() {
    ...
    <div style={{
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .glow-blue { color: #4fc3f7; text-shadow: 0 0 15px rgba(79,195,247,0.5); }
        ...
        .btn-primary:hover {
          background: linear-gradient(135deg, #ff8c42, #ffaa60);
        ...
        .clan-card {
          ...
          border: 1px solid rgba(255,107,35,0.15);
          padding: 20px 24px;
          position: relative;
          transition: all 0.3s;
          cursor: pointer;
        ...
        .clan-card:hover {
          ...
          box-shadow: -4px 0 0 #ff6b23, 0 0 30px rgba(255,107,35,0.15);
        }
        ...
        .scan-line {
          ...
          width: 100%;
          height: 2px;
          background: linear-gradient(90deg, transparent, rgba(255,107,35,0.3), transparent);
          pointer-events: none;
          z-index: 1;
        ...
        ::-webkit-scrollbar-thumb { background: #ff6b23; }
      `}</style>
      ...
      <div style={{
        ...
        background: "radial-gradient(ellipse at 20% 20%, rgba(255,107,35,0.06) 0%, transparent 60%), radial-gradient(ellipse at 80% 80%, rgba(79,195,247,0.04) 0%, transparent 60%)",
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <nav style={{
          ...
          padding: "20px 48px",
          borderBottom: "1px solid rgba(255,107,35,0.1)",
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 32 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <span style={{ fontSize: 20, fontWeight: 700, letterSpacing: 3, fontFamily: "Rajdhani, sans-serif" }}>
                <span className="glow-orange">OVER</span>
                <span style={{ color: "#e8eaf0" }}>CLAN</span>
              </span>
            </div>
        ...
        <section style={{ padding: "80px 48px 64px", maxWidth: 1200, margin: "0 auto" }}>
          ...
          <p className="animate-in delay-1" style={{
            marginTop: 24, fontSize: 16, color: "#8892a4", lineHeight: 1.7,
            maxWidth: 480, fontFamily: "Noto Sans KR, sans-serif", fontWeight: 300,
          }}>
            오버워치 최초의 클랜 플랫폼.<br/>
            혼자였던 게임이 함께하는 전쟁이 된다.
          </p>
          ...
          <div className="animate-in delay-3" style={{
            ...
            gap: 16, marginTop: 60, maxWidth: 600,
          }}>
            {stats.map(stat => (
              <div key={stat.label} className="stat-card">
                <div style={{
                  fontSize: 28, fontWeight: 700, fontFamily: "Rajdhani, sans-serif",
                  color: "#ff6b23", letterSpacing: 1,
                }}>{stat.value}</div>
                <div style={{ fontSize: 11, color: "#8892a4", marginTop: 4, letterSpacing: 1, fontFamily: "Noto Sans KR, sans-serif" }}>
                  {stat.label}
                </div>
              </div>
            ))}
        ...
        <section style={{ padding: "0 48px 80px", maxWidth: 1200, margin: "0 auto" }}>
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              ...
              <h2 style={{ fontSize: 16, fontWeight: 700, letterSpacing: 3, textTransform: "uppercase", fontFamily: "Rajdhani, sans-serif" }}>
                시즌 랭킹
              </h2>
            </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {clans.map((clan, i) => (
              <div key={clan.name} className={`clan-card animate-in delay-${i + 1}`}>
                {/* 코너 장식 */}
                <div className="corner-decoration" style={{ top: 0, right: 0, borderWidth: "0 1px 1px 0" }} />
                <div className="corner-decoration" style={{ bottom: 0, left: 0, borderWidth: "1px 0 0 1px" }} />

                <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
                  {/* 랭크 뱃지 */}
                  <div className="rank-badge" style={{
                    background: clan.rank === 1 ? "#ff6b23" : clan.rank === 2 ? "#8892a4" : clan.rank === 3 ? "#cd7f32" : "#1a2535",
                    color: clan.rank <= 3 ? "#fff" : "#8892a4",
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 12, marginTop: 4 }}>
                      <span className="tier-tag" style={{
                        borderColor: clan.tier === "마스터+" ? "rgba(255,107,35,0.5)" : "rgba(79,195,247,0.3)",
                        color: clan.tier === "마스터+" ? "#ff6b23" : "#4fc3f7",
                        fontSize: 10,
                      }}>{clan.tier}</span>
                  ...
                  <div style={{ textAlign: "right" }}>
                    <div style={{ fontSize: 22, fontWeight: 700, fontFamily: "Rajdhani, sans-serif", color: "#ff6b23" }}>
                      {clan.wins}승
                    </div>
          ...
          <div style={{ textAlign: "center", marginTop: 24 }}>
            <button className="btn-secondary" style={{ fontSize: 12 }}>전체 랭킹 보기</button>
          </div>
        </section>
        ...
        <section style={{
          padding: "60px 48px",
          background: "rgba(255,107,35,0.05)",
          borderTop: "1px solid rgba(255,107,35,0.1)",
          borderBottom: "1px solid rgba(255,107,35,0.1)",
          textAlign: "center",
        }}>
          <div style={{ fontSize: 11, letterSpacing: 4, color: "#ff6b23", marginBottom: 16, fontWeight: 600 }}>
            지금 바로 시작
          </div>
          <h2 style={{
          ...
          <p style={{ fontSize: 15, color: "#8892a4", marginBottom: 32, fontFamily: "Noto Sans KR, sans-serif", fontWeight: 300 }}>
        ...
        <footer style={{
          ...
          <span style={{ fontSize: 12, color: "#8892a4", fontFamily: "Rajdhani, sans-serif", letterSpacing: 2 }}>
            © 2025 OVERCLAN — 비공식 팬 플랫폼
          </span>
          <div style={{ display: "flex", gap: 24 }}>
            {["이용약관", "개인정보처리방침", "문의하기"].map(item => (
              <span key={item} style={{ fontSize: 11, color: "#8892a4", cursor: "pointer", letterSpacing: 1, fontFamily: "Noto Sans KR, sans-serif" }}>
                {item}
              </span>
            ))}
          </div>
